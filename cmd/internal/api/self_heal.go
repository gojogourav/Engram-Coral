...
Here is the live JSON state retrieved from the cluster:
%s

Determine the exact deployment name and decide how to fix it.
...
}`, podName, alertName, string(clusterData))
